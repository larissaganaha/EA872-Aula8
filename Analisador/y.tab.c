...
{
       0,    56,    56,    57,    60,    62,    64,    66,    70,    73,
      76,    80,    85,    88,    89,    90,    93,    97,    98,   101,
     102,   104,   105,   107,   113,   119
};
#endif
...
{
  "$end", "error", "$undefined", "PALAVRA", "COMANDO_GET", "PARAMETRO_SP",
  "PARAMETRO_UA", "COMANDO", "VIRGULA", "NL", "DP", "INVALIDO", "$accept",
  "linhas", "linha", "comando_get", "comando_sp", "comando", "erro",
